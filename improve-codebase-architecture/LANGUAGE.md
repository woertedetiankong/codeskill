...
**Compatibility layer**
A temporary **Module** that keeps an old **Interface** working while forwarding to a new one. Treat it as debt unless an ADR, public contract, or migration window requires it.
...
- A **Compatibility layer** is a temporary **Module**, not a default part of a deepened design.
